            ...
            <div class="ulogo">
                <a href="{{url('admin/dashboard')}}">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <img style="width: 30px; height: 30px;" src="{{ asset('backend/images/logo-dark.png') }}"
                            alt="">
                ...
                <li class="treeview {{ $prefix == '/category' ? 'active' : '' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ $route == 'all.subcategory' ? 'active' : '' }}"><a
                                href="{{ route('all.subcategory') }}"><i class="ti-more"></i>All Sub Categories</a>
                        </li>
                        <li class="{{ $route == 'all.childcategory' ? 'active' : '' }}"><a
                                href="{{ route('all.childcategory') }}"><i class="ti-more"></i>All Child Categories</a>
                        </li>
